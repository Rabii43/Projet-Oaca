...
class __TwigTemplate_2bd6ee5833ca2b6cb87e6405c27e2c2cf3064a690b18593531d4458d19b322cd extends Template
{
    private $source;
    private $macros = [];
...
<div class=\"sf-tabs\">
    <div class=\"tab\">
        ...
        // line 10
        if ((0 === twig_compare(0, twig_get_attribute($this->env, $this->source, (isset($context["collector"]) || array_key_exists("collector", $context) ? $context["collector"] : (function () { throw new RuntimeError('Variable "collector" does not exist.', 10, $this->source); })()), "getNumHandlers", [0 => "called"], "method", false, false, false, 10)))) {
            // line 11
    ...
    public function macro_render_not_table_triggered_handlers($__handlers__ = null, ...$__varargs__)
    {
        ...
        try {
            ...
            foreach ($context['_seq'] as $context["direction"] => $context["callsByType"]) {
                ...
                echo "<h3>";
                // line 31
                if ((0 === twig_compare($context["direction"], twig_constant("JMS\\Serializer\\GraphNavigatorInterface::DIRECTION_SERIALIZATION")))) {
                    // line 32
                    echo "Serialization";
                } else {
                    // line 34
...
{%- macro render_table_triggered_handlers(handlers) -%}
    ...
    {%- endfor -%}
{%- endmacro -%}
", "@JMSSerializer/Collector/handlers.html.twig", "/home/terres-rabii/Documents/travail/Pfe/Projet-Oaca/vendor/jms/serializer-bundle/Resources/views/Collector/handlers.html.twig");
    }
}
